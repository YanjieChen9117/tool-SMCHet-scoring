...
/*-----------------------------------------------
              @(target):= _c_extensions.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__c_extensions

#else
#  define SWIG_init    init_c_extensions

#endif
#define SWIG_name    "_c_extensions"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_filterFPs_remove_fps(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:filterFPs_remove_fps",&obj0,&obj1)) SWIG_fail;
  {
  ...
  filterFPs_remove_fps(arg1,arg2,arg3,arg4,arg5);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"filterFPs_remove_fps", _wrap_filterFPs_remove_fps, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
